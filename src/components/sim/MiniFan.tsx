...
export function MiniFan({ profile }: { profile: SimProfile }) {
  ...
  return (
    <div className="stack stack-s">
      ...
      <dl className="grid" style={{ gridTemplateColumns: "1fr 1fr", gap: "var(--s-3)" }}>
        ...
        <div className="stat"><dt className="stat-label">Chance of 50% drawdown</dt><dd className="num">{pct(result.ruinProbability)}</dd></div>
      </dl>
    </div>
  );
}
